...
const Sponsor = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			try {
				// const response = await fetch("http://ec2-54-215-25-13.us-west-1.compute.amazonaws.com:8000/api/books"); // Replace with your API endpoint
	...
	const makeUpdateCall = async (bookId, updatedBook) => {
		...
		try {
			const response = await fetch(
				"http://ec2-54-215-25-13.us-west-1.compute.amazonaws.com:8000/api/update/${bookId}/",
				{
					method: "PUT",
					headers: {
